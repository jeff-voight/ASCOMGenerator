...
*/
public void Cel2Ter(Double,Double,Double,ASCOM.Astrometry.Method,ASCOM.Astrometry.Accuracy,ASCOM.Astrometry.OutputVectorOption,Double,Double,Double[],Double[]@){
return null;
}
...
*/
public void Wobble(Double,ASCOM.Astrometry.TransformationDirection,Double,Double,Double[],Double[]@){
return null;
}
